                ...
                <div className="container">
                    ...
                    <div className="col-3 dateDiv align-content-center"></div></div>
                        <div className="row align-content-center">
                            <div className="col-4">
                            <button className="primary-btn fillDiv " style={{width: "40%", float: "right"}} onClick={() => this.changeDate(-1)}>&#171;</button>
                            </div>
                            ...
                            <div className="col-4">
                                <button className="primary-btn fillDiv" style={{width: "40%", float: "left"}}  onClick={() => this.changeDate(1)}>&#187;</button>
                            </div> 
                        </div>
